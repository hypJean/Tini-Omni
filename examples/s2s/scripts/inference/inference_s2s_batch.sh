...
# huggingface dataset
manifest_format=jsonl      # manifest format: jsonl or parquet
...
test_data_name=Jiann_STORAL_default_storal_en_test_short
val_data_path="${base_path}/evaluation/voice_prompt/${test_data_name}/manifest.jsonl"
...
# 跑评估的音频以及日志输出路径
decode_log="${base_path}/evaluation/model_answer/${ckpt_name}/${test_data_name}"
